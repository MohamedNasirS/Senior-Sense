...
const Index = () => {
  return <div className="min-h-screen overflow-hidden">
      ...
      <section className="relative pt-20 pb-32 px-6 flex items-center justify-center">
        {/* Background gradient */}
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-br from-blue-50 via-transparent to-indigo-50 -z-10" aria-hidden="true"></div>
        
        {/* Floating elements */}
        <div className="absolute top-[15%] left-[10%] w-24 h-24 rounded-full bg-blue-500/5 animate-float" style={{
        animationDelay: '0.5s'
      }} aria-hidden="true"></div>
        <div className="absolute top-[60%] left-[20%] w-16 h-16 rounded-full bg-indigo-500/5 animate-float" style={{
        animationDelay: '1.2s'
      }} aria-hidden="true"></div>
        <div className="absolute top-[25%] right-[15%] w-20 h-20 rounded-full bg-indigo-500/5 animate-float" style={{
        animationDelay: '0.8s'
      }} aria-hidden="true"></div>
        <div className="absolute bottom-[20%] right-[10%] w-12 h-12 rounded-full bg-blue-500/5 animate-float" style={{
        animationDelay: '1.5s'
      }} aria-hidden="true"></div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10 text-balance animate-fade-in" style={{
          ...
          animationDelay: '300ms'
            ...
            <CustomButton variant="outline" size="lg" icon={<Zap size={20} />}>
              Learn More
            </CustomButton>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-6xl mx-auto">
          ...
          }} className="glass-card p-6 rounded-2xl hover-lift animate-fade-in bg-slate-900">
